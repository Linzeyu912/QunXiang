...
set "ROOT=%~dp0"
set "DB_URL=postgresql://novel_agent:change_me_in_production@127.0.0.1:5432/novel_agent"

echo ========================================
echo   Novel Agent - 启动脚本
echo ========================================
echo.
...
echo [5/6] 启动 API 服务...
cd /d "%~dp0api"
start "Novel Agent API" cmd /k "chcp 65001>nul & pnpm dev"
cd /d "%~dp0"
