...
describe('executeValidator', () => {
  it('passes character description packs through to later pipeline stages', async () => {
    const characterDescriptions = [descriptionPack()];
